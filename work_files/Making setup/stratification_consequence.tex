...
\]
be a decomposition into locally closed $G_d^{\sigma_S}$-stable strata. Assume that each stratum is a union of $G_d^{\sigma_S}$-orbits and that the indexing set $A$ is finite.
...
\]
and this decomposition is a stratification by locally closed $G_d^{\sigma_S}$-stable pieces.
\end{proposition}

\begin{proof}[Formal argument]
By the orbit-bijection conjecture, every $G_d^{\sigma_S}$-orbit in $\Gamma_{d,S}^r$ meets $\mathcal C_{d,S}^r$, and two points of $\mathcal C_{d,S}^r$ lie in the same orbit in $\Gamma_{d,S}^r$ if and only if they represent the same orbit on the critical locus.

Therefore the orbit partition of $\Gamma_{d,S}^r$ restricts to an orbit partition of $\mathcal C_{d,S}^r$. Grouping the critical orbits according to the ambient strata $\mathcal O_\alpha$ gives the decomposition above.
\end{proof}
...
\begin{itemize}
\item classify the $G_d^{\sigma_S}$-orbits in $\Gamma_{d,S}^r$;
